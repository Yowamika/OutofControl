...
namespace Car
{
    ...
    public class CarController : MonoBehaviour
    {
        ...
        // タイヤのRigidbodyの質量のオフセット値を設定する
        [SerializeField] private Vector3 m_CentreOfMassOffset;
        // 左右のキーを押した時のハンドルが動く角度
        [SerializeField] private float m_MaximumSteerAngle;
        // ハンドルの動きの補助作用(0で物理的な作用、1は車が向いている方向に作用する)
        [Range(0, 1)] [SerializeField] private float m_SteerHelper;
        // 車輪が回り過ぎた時に引っ張る(0だと何もしない、1だと引っ張る)
        ...
        // ハンドブレーキを使用した時の最大回転角度
        [SerializeField] private float m_MaxHandbrakeTorque;
        // 車が地面に抑えつけられる力
        [SerializeField] private float m_Downforce = 100f;
        // 速度をMPH（マイル）かKPH（キロ）で表すか
