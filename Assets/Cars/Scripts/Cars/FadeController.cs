...
public class FadeController : MonoBehaviour
{
    ...
    void StartFadeOut()
    {
        ...
        {             // d)完全に不透明になったら処理を抜ける
            ...
            userController.SetHorizontal(0.0f);
            userController.SetDash(0.0f);
            userController.SetRestart(0.0f);
            userController.SetVertical(0.0f);
            alfaOne = true;
